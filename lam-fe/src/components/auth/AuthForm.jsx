...
//                   First Name
//                 </Label>
//                 <Input id="firstName" type="text" placeholder="First Name" className="h-11" required />
//               </div>
//               <div className="space-y-2">
//                 <Label htmlFor="lastName" className="text-sm font-medium text-gray-700">
//                   Last Name
//                 </Label>
//                 <Input id="lastName" type="text" placeholder="Last Name" className="h-11" required />
//               </div>
//             </div>
...
//                 Organization
//               </Label>
//               <Input id="organization" type="text" placeholder="Your organization" className="h-11" required />
//             </div>
//           </>
//         )}
...
//             Email
//           </Label>
//           <Input id="email" type="email" placeholder="your@gmail.com" className="h-11" required />
//         </div>
//         <PasswordField />
//         {/* <div className="space-y-2">
...
//             <input type="checkbox" className="mt-1 mr-1 h-4 w-4 bg-white border border-black checked:bg-black" required/>{" "}
...
//   const onSubmit = (e) => {
//     e.preventDefault();
//     handleSubmit(formData); // Pass collected data to parent
//   };
...
//                 <Input id="firstName" type="text" placeholder="First Name" className="h-11" value={formData.firstName} onChange={handleChange} required />
//               </div>
//               <div className="space-y-2">
//                 <Label htmlFor="lastName">Last Name</Label>
//                 <Input id="lastName" type="text" placeholder="Last Name" className="h-11" value={formData.lastName} onChange={handleChange} required />
//               </div>
//             </div>

//             <div className="space-y-2">
//               <Label htmlFor="organization">Organization</Label>
//               <Input id="organization" type="text" placeholder="Your organization" className="h-11" value={formData.organization} onChange={handleChange} required />
//             </div>
//           </>
//         )}
...
//           <Input id="email" type="email" placeholder="your@gmail.com" className="h-11" value={formData.email} onChange={handleChange} required />
//         </div>
